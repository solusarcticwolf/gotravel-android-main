...
public class AirlineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Boolean imageshow;
    public AirlineAdapter(Context context, ArrayList<Airline> data,Boolean imageshow) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        ...
        AirlineAdapter.MyViewHolder holder = new AirlineAdapter.MyViewHolder(view);
        return holder;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        final AirlineAdapter.MyViewHolder myViewHolder = (AirlineAdapter.MyViewHolder)holder;
        ...
        final String linkimage= Constant.linkimage +flightModel.getName()+Constant.linkimagetype;
