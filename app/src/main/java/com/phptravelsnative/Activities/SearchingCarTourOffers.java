...
public class SearchingCarTourOffers extends Drawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(SearchingCarTourOffers.this);
        layoutInflaterAndroid = LayoutInflater.from(SearchingCarTourOffers.this);
        ...
        switch (checkType) {
            case "cars":
                ...
                if(c.getPickupId()!=0) {
                   ...
                   // url = Constant.domain_name + "cars/search?appKey=" + Constant.key + "&pickupLocation=" + c.getPickupId() + "&dropoffLocation=" + c.getPickupId() + "&pickupDate=" + c.getPickupDate() + "&dropoffDate=" + c.getDropOfDate() + "&pickupTime=" + c.getPickupTime() + "&dropoffTime=" + c.getDropOfTime() + offset_get+"1" + "&lang=" + Constant.default_lang;
            ...
            case "tour":
                ...
                }else
                {
                    ...
                    if (t.getType().contains("AllCategories"))
                    {
                        url = Constant.domain_name+"tours/search?appKey="+Constant.key+"&id="+t.getId()+"&date=" + t.getDate() + "&type="+"&adults=" + t.getGusest() + offset_get+"1" +"&lang=" + Constant.default_lang;
