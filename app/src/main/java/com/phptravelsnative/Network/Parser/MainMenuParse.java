            ...
            if(error_object.getBoolean("status"))
            {
                ...
                for (int i = 0; i < parentArray.length(); i++)
                {
                   ...
                   if(finalObject.getString("title").toLowerCase().equals("hotels")) {
                    ...
                    }else if(finalObject.getString("title").toLowerCase().equals("travelport_flight"))
                   {
                       menuModel = new MenuModel();
                       menuModel.setDescription(R.string.hotesDescription);
                       menuModel.setTitle(R.string.hotels);
                       menuModel.setType("0tp");
                       menuModels.add(menuModel);
                   }else if(finalObject.getString("title").toLowerCase().equals("flights"))
                   {
                       menuModel = new MenuModel();
                       menuModel.setDescription(R.string.flightsDescription);
                       menuModel.setTitle(R.string.filghts);
                       menuModel.setType("2flights");
                       menuModels.add(menuModel);
                        ...
                        else if(finalObject.getString("title").toLowerCase().equals("travelpayouts"))
                        {
                            ...
                            menuModel.setDescription(R.string.flightsDescription);
                            menuModel.setTitle(R.string.filghts);
                            menuModel.setType("4Travelpayouts");
                            menuModels.add(menuModel);
                        }
                        else if(finalObject.getString("title").toLowerCase().equals("travelstart"))
                        {
                            ...
                            menuModel.setDescription(R.string.flightsDescription);
                            menuModel.setTitle(R.string.filghts);
                            menuModel.setType("5Travelstart");
                            menuModels.add(menuModel);
                        }
                        ...
                        else if(finalObject.getString("title").toLowerCase().equals("tours"))
                        {
                            ...
                            menuModel.setType("7default_tour");
                            menuModels.add(menuModel);
                        }
                        else if(finalObject.getString("title").toLowerCase().equals("wegoflights"))
                        {
                            ...
                            menuModel.setDescription(R.string.flightsDescription);
                            menuModel.setTitle(R.string.filghts);
                            menuModel.setType("8Wegoflights");
                            menuModels.add(menuModel);
                        }
                         else if(finalObject.getString("title").toLowerCase().equals("hotelscombined"))
                        {
                            ...
                            menuModel.setDescription(R.string.hotesDescription);
                            menuModel.setTitle(R.string.hotels);
                            menuModel.setType("9hotelscombined");
                            menuModels.add(menuModel);
                        ...
                        }else if(finalObject.getString("title").toLowerCase().equals("offers"))
                        {
                            ...
                            menuModels.add(menuModel);
                        }else if(finalObject.getString("title").toLowerCase().equals("ivisa"))
                        {
                            menuModel = new MenuModel();
                            menuModel.setTitle(R.string.ivisa);
                            menuModel.setType("9ivisa");
                            menuModels.add(menuModel);
                        }

                        String title = finalObject.getString("title");
                        Boolean staus = finalObject.getBoolean("status");
                        if (title.contentEquals("TravelhopeFlights"))
                        {
                            if(staus.equals(true))
                            {
                                menuModel = new MenuModel();
                                menuModel.setDescription(R.string.TravelhopeFlights);
                                menuModel.setTitle(R.string.TravelhopeFlights);
                                menuModel.setType("3flightshope");
                                menuModels.add(menuModel);
                            }
                        ...
                        if(title.contentEquals("TravelhopeHotels"))
                        {
                            menuModel = new MenuModel();
                            menuModel.setDescription(R.string.hotesDescription);
                            menuModel.setTitle(R.string.hotels);
                            menuModel.setType("hopeHotels");
                            menuModels.add(menuModel);
                        }
                         if(title.contentEquals("FlightTarco"))
                        {
                            menuModel = new MenuModel();
                            menuModel.setDescription(R.string.flightsDescription);
                            menuModel.setTitle(R.string.filghts);
                            menuModel.setType("flighttarco");
                            menuModels.add(menuModel);
