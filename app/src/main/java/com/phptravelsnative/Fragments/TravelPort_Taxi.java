...
public class TravelPort_Taxi extends Fragment  {
    ...
    RelativeLayout btn_origin ;
    RelativeLayout btn_destination;
    RelativeLayout rl_deprat,rl_return;
    ...
    LinearLayout data_select_area,lt_trip_class;
    ...
    public static Fragment newInstance(String type) {
        TravelPort_Taxi fragment = new TravelPort_Taxi();
    ...
    public TravelPort_Taxi() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        inflated  =  inflater.inflate(R.layout.travelport_taxi, container, false);

        hotel_data = new Hotel_data();
        sharedPreferences =new ComplexPreferences(getContext(),MyPREFERENCES, Context.MODE_PRIVATE);

        rl_return = (RelativeLayout) inflated.findViewById(R.id.rl_return);
        rl_deprat= (RelativeLayout) inflated.findViewById(R.id.rl_deprat);


        btn_origin = (RelativeLayout) inflated.findViewById(R.id.btn_origin);
        btn_destination= (RelativeLayout) inflated.findViewById(R.id.btn_destination);

        hotel_name = (RobotoTextView) inflated.findViewById(R.id.tv_cityto);
        tv_cityfrom  = (RobotoTextView) inflated.findViewById(R.id.tv_cityfrom);


        //tv_id  = (RobotoTextView) inflated.findViewById(R.id.tv_id);
        //    btn_origin = (RelativeLayout) inflated.findViewById(R.id.btn_origin);
        //tv_from  = (RobotoTextView) inflated.findViewById(R.id.tv_from);
      //  tv_airportfrom = (RobotoTextView) inflated.findViewById(R.id.tv_airportfrom);
       // tv_airportto= (RobotoTextView) inflated.findViewById(R.id.tv_airportto);
       // tv_fromdate= (RobotoTextView) inflated.findViewById(R.id.tv_fromdate);
       // tv_dayfrom= (RobotoTextView) inflated.findViewById(R.id.tv_dayfrom);
       // tv_dateretun= (RobotoTextView) inflated.findViewById(R.id.tv_dateretun);
       // tv_dayretun= (RobotoTextView) inflated.findViewById(R.id.tv_dayretun);
       // tv_trip_class= (RobotoTextView) inflated.findViewById(R.id.tv_trip_class);


       // lt_trip_class = inflated.findViewById(R.id.lt_trip_class);
      //  data_select_area = inflated.findViewById(R.id.data_select_area);
      //  data_select_area.setVisibility(View.GONE);
       // lt_trip_class.setVisibility(View.GONE);

        //btn_return_date_switch = (ImageView) inflated.findViewById(R.id.btn_return_date_switch);
...
//        tv_id.setText(searchHotel.getType());
       ...
       // tv_airportto.setVisibility(View.GONE);
     ...
     /*   cabin_home.setOnClickListener(new View.OnClickListener() {
        ...
        btn_return_date_switch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                {
                    checkTourType = "oneway";
                    tv_dateretun.setText("Return date");
                    tv_dayretun.setText("day of the week");
                    checkBoxState=false;
                    btn_return_date_switch.setVisibility(View.GONE);
                }
...
/*        search= (Button) inflated.findViewById(R.id.search_hotels);
        ...
        btn_origin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("ModuleTyple","TravelPort_fromtaxi");
        ...
        btn_destination.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getContext(),SearchViewActivity.class);
                intent.putExtra("ModuleTyple","TravelPort_totaxi");
    ...
    public void onClickButton() {
        ...
        Intent intent = new Intent(getContext(), Find_Taxi.class);
