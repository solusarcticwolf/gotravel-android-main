                ...
                new Response.Listener() {
                    ...
                    public void onResponse(Object response) {
                        ...
                        try {
                            ...
                            HotelModel hm;
                            for(int i=main_object.length()-1;i>=0;i--)
                            {
                                ...
                                if (jsonObject.has("currSymbol")){

                                    hm.setPrice(jsonObject.getString("currCode")+jsonObject.getString("currSymbol")+" "
                                            +jsonObject.getString("checkoutTotal"));
                                    hm.setcurrSymbol("Check IN "+jsonObject.getString("checkin"));
                                    hm.setcurrCode("Check Out "+jsonObject.getString("checkout"));

                                }else{

                                    hm.setPrice(jsonObject.getString("currCode")+" "
                                            +jsonObject.getString("checkoutTotal"));
                                    hm.setcurrSymbol("Departure "+jsonObject.getString("checkin"));
                                    hm.setcurrCode("Return "+jsonObject.getString("checkout"));
