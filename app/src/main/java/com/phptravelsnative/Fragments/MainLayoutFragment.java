...
//        });
     ...
     //   adapter.addFragment(new Travelshope_Hotels(),getString(R.string.hotels));



        for(int i=0;i<size;i++)
        {
            String data =SplashActivity.menuModels.get(i).getType();
            Log.d("abcedf",data+"");
         ...
         if(SplashActivity.menuModels.get(i).getType().equals("1default"))
            ...
            else if(SplashActivity.menuModels.get(i).getType().equals("3ean"))
                adapter.addFragment(new Expedia_Hotel(),getString(R.string.hotels));

            else if(SplashActivity.menuModels.get(i).getType().equals("0tp"))
           adapter.addFragment(TravelPort_Home.newInstance("travelport"),getString(R.string.filghts));

            else if(SplashActivity.menuModels.get(i).getType().equals("2flights"))
            adapter.addFragment(TravelPort_Home.newInstance("manual"),getString(R.string.filghts));

            else if(SplashActivity.menuModels.get(i).getType().equals("4Travelpayouts"))
                adapter.addFragment(WebViewFragments.newInstance("Travelpayouts"),getString(R.string.filghts));

            else if(SplashActivity.menuModels.get(i).getType().equals("5Travelstart"))
                adapter.addFragment(WebViewFragments.newInstance("Travelstart"),getString(R.string.filghts));

            else if(SplashActivity.menuModels.get(i).getType().equals("6dhop"))
                adapter.addFragment(WebViewFragments.newInstance("dohope"),getString(R.string.filghts));

           else if(SplashActivity.menuModels.get(i).getType().equals("7default_tour"))
                adapter.addFragment(new Tour(),getString(R.string.Tours));

            else if(SplashActivity.menuModels.get(i).getType().equals("8Wegoflights"))
                adapter.addFragment(WebViewFragments.newInstance("wego"),getString(R.string.filghts));

            else if(SplashActivity.menuModels.get(i).getType().equals("9hotelscombined"))
            ...
            else if(SplashActivity.menuModels.get(i).getType().equals("9default_cars"))
         {
            ...
            else if(SplashActivity.menuModels.get(i).getType().equals("9ivisa"))

             adapter.addFragment(new ivisa_home(),"VISA");
            ...
            else if(SplashActivity.menuModels.get(i).getType().equals("9cartrawler"))
         {
            ...
            else if(SplashActivity.menuModels.get(i).getType().equals("Travelpayouts"))
             adapter.addFragment(Travelpayouts_Home.newInstance("manual"),getString(R.string._dislyeTravelpayouts));


            else if(SplashActivity.menuModels.get(i).getType().equals("3flightshope"))
             adapter.addFragment(TravelHope_Flights.newInstance("manual"),getString(R.string.TravelhopeFlights));

            else if(SplashActivity.menuModels.get(i).getType().equals("TravelhopeFlights"))
             adapter.addFragment(TravelHope_Flights.newInstance("manual"),getString(R.string.TravelhopeFlights));

            else if(SplashActivity.menuModels.get(i).getType().equals("Kiwitaxi"))
             adapter.addFragment(TravelPort_Taxi.newInstance("manual"),getString(R.string.TravelhopeFlights));


            else if(SplashActivity.menuModels.get(i).getType().contentEquals("hopeHotels"))

                adapter.addFragment(new Travelshope_Hotels(),getString(R.string.hotels));


            else if(SplashActivity.menuModels.get(i).getType().equals("flighttarco"))

             adapter.addFragment(new TarcoFlight_Home().newInstance("manual"),getString(R.string.filghts));
