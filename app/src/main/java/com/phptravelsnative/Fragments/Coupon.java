...
public class Coupon extends Fragment {
    ...
    public static Coupon newInstance(String itemId, TravelPort cabin_class) {
        Coupon fragment = new Coupon();
        Bundle args = new Bundle();
        args.putParcelable("cabin_class", cabin_class);
        args.putString("check_type", "flights");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            cabin_class=getArguments().getParcelable("cabin_class");
            item_id = getArguments().getString("id");
        }
        ...
        continue_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    bundle.putParcelable("cabin_class",cabin_class);
    ...
    private void _verfyCode()
    {
        ...
        {
            requestRegister = new Check_Coupon(coupon_code.getText().toString(), 2, "flights", listener);
